...
class WinnersControllerTest < ActionController::TestCase
  ...
  test "should create winner" do
    assert_difference('Winner.count') do
      post :create, winner: { Points: @winner.Points, Team: @winner.Team, Year: @winner.Year, Year: @winner.Year }
    end
  ...
  test "should update winner" do
    put :update, id: @winner, winner: { Points: @winner.Points, Team: @winner.Team, Year: @winner.Year, Year: @winner.Year }
    assert_redirected_to winner_path(assigns(:winner))
  end
